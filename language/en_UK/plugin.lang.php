...
$lang['Disclaimer'] = '  <div class="warning">Important: FluxBB and Piwigo must be installed in the same database! For safety, be sure to make a backup of your database and especially your ###_user tables before any action.</div><br/><br/>
  *** To begin, follow these two steps ***<br/>
...
$lang['About_Reg_Title'] = 'About user registration in the FluxBB forum';
$lang['About_Reg_Title_d'] = 'Useful instructions for better integration';
$lang['No_Reg_advise'] = '  For better integration, it is advisable to make the following changes to your FluxBB forum (<b>Warning: These changes will disappear when updating the forum script</b>):
<br/><br/>
...
$lang['About_Bridge_Title_d'] = 'Instruction about the bridge between the Register_FluxBB and UserAdvManager plugins';
...
<br/>
- In the administration panel of your FluxBB forum, set at least two groups of users (for example: "validated" and "no_validated").<br/>
...
$lang['Config_Title1'] = 'Settings of the bridge between FluxBB and Piwigo';
...
$lang['Error_Link_Del'] = '<b>Error in the link table between two users:</b> ';
$lang['Link_Del'] = 'Removal of link: ';
$lang['Error_Link_Dead'] = '<b>Error in the link table, dead links:</b> ';
$lang['Link_Dead'] = 'Removal of dead links ';
$lang['Error_Link_Dup'] = '<b>Error in the link table, there are duplicates:</b> ';
$lang['Link_Dup'] = 'Removal of duplicates ';
...
$lang['Add_User'] = 'Adding an account in FluxBB: ';
...
$lang['Del_User'] = 'Removal of account in FluxBB: ';
$lang['Audit_OK'] = 'Audit OK<br/><br/>';

$lang['RegFluxBB_Password_Reset_Msg'] = 'Please update your password for synchronization with the forum. Then you will be able to login to the forum with the same account as the gallery.';

$lang['Add_User2pwg'] = 'Adding an account in Piwigo: ';
